...
// Problem 2: Pop Front
// Given an array, remove and return the value at the beginning of the array. Prove the value is removed from the array by 
// printing it. You may use .pop(), you are able do this without it though!
...
const popFront = (arr) => {
    let num = arr.shift()
    console.log('The number removed is ' + num)
    return arr
}
...
// Problem 3: Insert At
// Given an array, index, and additional value, insert the value into array at given index. You can think of 
// pushFront(arr,val) as equivalent to insertAt(arr,0,val). You may use .push(), you are able do this without it though!
...
// Problem 6: BONUS: Remove Duplicates
...
// console.log(removeDupes([1,1,2,2,3,4,5,5,5,6,7,7,1,2,3,4,5,6,7]))