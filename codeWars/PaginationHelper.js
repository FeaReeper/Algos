...
class PaginationHelper {
    constructor(collection, itemsPerPage) {
        ...
        if (this.collection.length % this.itemsPerPage != 0) return this.collection.length % this.itemsPerPage
        }
        pageIndex(itemIndex) {
        ...
        return Math.ceil(itemNumber / this.itemsPerPage)
        }
}

let helper = new PaginationHelper(['a','b','c','d','e','f','g'], 2)
